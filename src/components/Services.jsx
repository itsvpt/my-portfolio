...
const servicesData = [
  {
    ...
    description:
      "I build scalable, high-performance web applications using modern frontend frameworks like React.js & Next.js, coupled with robust backend architecture powered by Node.js, Nest.js, FastAPI, MySQL, MongoDB, PostgreSQL, and Supabase databases.",
    capabilities: [
      "Responsive Web Apps with React.js & Tailwind CSS",
      "Scalable Server Architecture with Node.js, FastAPI & Nest.js",
      "Database Design & Optimization with MySQL, MongoDB and PostgreSQL",
  ...
  },
  {
    ...
    description:
      "I build fast, responsive mobile applications for iOS and Android using React Native and Expo, featuring smooth animations, offline state management, dynamic parallax scrolling, and intuitive user interfaces.",
    capabilities: [
  ...
  },
  {
    ...
    description:
      "I architect secure and reliable server-side systems with well-structured relational (MySQL) and NoSQL (MongoDB, Supabase) databases to handle authentication, real-time data streaming, and security.",
    capabilities: [
  ...
  },
  {
    ...
    description:
      "I create custom full-stack solutions including boutique e-commerce stores, restaurant ordering systems, event booking engines, social community platforms, personal asset management tools, and apps like TikTok Shop Seller Center.",
    capabilities: [
    ...
    >
      ...
      <div className="z-10 relative mt-0 -mx-6 md:-mx-16 border-t border-white/20">
        {servicesData.map((service, index) => {
          const isHighlighted =
            activeIndex === index || (!isMobile && hoveredIndex === index);
